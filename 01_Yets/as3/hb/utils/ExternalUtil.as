...
/*			if (Security.sandboxType == Security.LOCAL_TRUSTED)
		...
		public static function getIsInBrowser():Boolean
		{
		...
		public static function callJS(method:String, args:Array=null, target:String = '_self'):void
		{
			if (!IS_IN_BROWSER)
			{
		...
		public static function callJSNormal(str:String, target:String = '_self'):void
		{
			if (!IS_IN_BROWSER)
			{
				DebugUtil.test('ExternalUtil : Not In Browser');
		...
		public static const IS_IN_BROWSER:Boolean = getIsInBrowser();
