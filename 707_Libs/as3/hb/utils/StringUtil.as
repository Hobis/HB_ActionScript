...
package hb.utils
{
	public final class StringUtil
	{
		...
		// :: 토큰문자 개수만큼 채우기
		public static function addToken(target:String, count:int, token:String = '0'):String
		{
		...
		// :: [String]문자열 처음,끝 공백제거
		public static function getWhiteSpaceClear(target:String, type:String = 'be'):String
		{
		...
		public static function getLastIndex2(name:String, step:uint = 0, token:String = '_'):int
		{
			var t_rv:int = -1;
		...
		// :: [String]현재 파일 이름만 반환
		public static function getThisName(url:String, extStr:String = 'swf'):String
		{
